...
VIVADO_BIN_DIR="/mnt/applications/Xilinx/20.2/Vivado/2020.2/bin"
...
/mnt/applications/Xilinx/20.2/Vivado/2020.2/bin/xelab work.mult -prj mult.prj -dll -s $OUT_SIM_SNAPSHOT -debug wave

/mnt/applications/Xilinx/20.2/Vivado/2020.2/data/xsim/include

# Compile the C++ code that interfaces with XSI of ISim
#$GCC_COMPILER -I$XSI_INCLUDE_DIR  -g -c -o xsi_loader.o xsi_loader.cpp
$GCC_COMPILER -I /mnt/applications/Xilinx/20.2/Vivado/2020.2/data/xsim/include -O3 -c -o xsi_loader.o ./src/xsi_loader.cpp
$GCC_COMPILER -I /mnt/applications/Xilinx/20.2/Vivado/2020.2/data/xsim/include -O3 -c -o register.o ./src/Register.cpp
# Compile the program that needs to simulate the HDL design
#$GCC_COMPILER -I$XSI_INCLUDE_DIR  -g -c -o testbench.o testbench.cpp
$GCC_COMPILER -I /mnt/applications/Xilinx/20.2/Vivado/2020.2/data/xsim/include -O3 -c -o testbench.o multiplierTestbench.cpp
