...
def main():
    ...
    normal = pd.read_csv('data/1-128addition.csv')
    karatsuba = pd.read_csv('data/1-128subtraction.csv')
    LUT_Graph = normal.plot(x = 'IN1', y = 'LUTs', label = 'Addition', title = 'LUT usage against Input Width')
    karatsuba.plot(ax = LUT_Graph, x = 'IN1', y = 'LUTs', ylabel = 'LUTs', label = 'Subtraction')
